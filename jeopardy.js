...
$('#five').append('<button>A</button>').append(genres10.rightAnswer, $('<br>'))
$('#five').append('<button>B</button>').append(genres10.wrongAnswer1, $('<br>'))
$('#five').append('<button>C</button>').append(genres10.wrongAnswer2, $('<br>'))
